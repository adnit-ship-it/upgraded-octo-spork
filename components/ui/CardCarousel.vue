<template>
  <div
    class="relative flex flex-col md:flex-row justify-start items-center w-full md:overflow-x-auto lg:h-[460px] border-t border-b border-l border-[#D9D9D9] overflow-hidden md:overflow-x-auto scrollbar-hide md:snap-x md:snap-mandatory">
